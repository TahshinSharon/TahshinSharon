...
<h2 align="center">🚀 Software Engineer(Backend)| Go |Python| GraphQL |RestApi| gRPC | MongoDB|PostgreSQL|DevOps|CI/CD|Docker|Kubernetes|AWS</h2>
...
### 🔹 Dynamic Qr Based FutureBook

* Built scalable QR code management system
